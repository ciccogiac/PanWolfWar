...
APanWarAIController::APanWarAIController(const FObjectInitializer& ObjectInitializer)
...
void APanWarAIController::BeginPlay()
{
	Super::BeginPlay();
...
void APanWarAIController::OnEnemyPerceptionUpdated(AActor* Actor, FAIStimulus Stimulus)
{
